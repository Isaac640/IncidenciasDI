...
IRIS Tickets es una aplicación de Python diseñada como una herramienta para administradores de incidencias. Permite la creación de tickets para registrar y gestionar el tiempo dedicado a resolver cada incidencia. Los usuarios pueden iniciar, pausar, reanudar, eliminar o asignar tickets a otros administradores, proporcionando un seguimiento detallado del proceso de resolución de incidencias. 

### Dependencias

Para ejecutar IRIS Tickets, es necesario tener instaladas las siguientes dependencias:

- CustomTkinter
- Pillow
- Request

Estas dependencias pueden instalarse utilizando pip:
...
- Pausar ticket
- Eliminar ticket
- Asignar ticket a otro administrador

**Nota**:
- Los datos guardados sobre los tickets serán guardados en un archivo JSON
