...
namespace Grupo_1_DI
{
    ...
    public partial class FrmIncidencia : Form
    {
        ...
        {
            // me cago en mis muertos con este codigo de mierda
            ...
            {
                cmbTipoIncidencia.Text = "";
                cmbTipoIncidencia.Items.Clear();
                cmbTipoIncidencia.Enabled = true;
                cmbTipoIncidencia.Items.Add("EDUCANTABRIA");
                cmbTipoIncidencia.Items.Add("GOOGLE CLASSROOM");
                cmbTipoIncidencia.Items.Add("DOMINIO");
                cmbTipoIncidencia.Items.Add("YEDRA GESTIONA J.EST.");
            ...
            else if (cmbTipoIncidencia.Text == "WiFi")
            {
                ...
                cmbTipoIncidencia.Items.Clear();
                cmbTipoIncidencia.Enabled = true;
                cmbTipoIncidencia.Items.Add("IESMIGUELHERRERO");
                cmbTipoIncidencia.Items.Add("WIECAN");
                txtEtiqueta.Enabled = false;
                txtAula.Enabled = false;
                txtPuesto.Enabled = false;
            }
            else if (cmbTipoIncidencia.Text == "Internet")
            {
                ...
                cmbTipoIncidencia.Items.Clear();
                cmbTipoIncidencia.Enabled = true;
                cmbTipoIncidencia.Items.Add("INSTALACION");
                cmbTipoIncidencia.Items.Add("ACTUALIZACION");
                txtEtiqueta.Enabled = false;
                txtAula.Enabled = false;
                txtPuesto.Enabled = false;
            }
